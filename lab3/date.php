...
$now = time();
$birthday = mktime(0, 0, 0, 7, 25, (int)date('Y'));
$hour = getdate()['hours'];
...
<body>
    ...
    */
    ...
    if ($timeToBirthday < 0) {
        $birthday = mktime(0, 0, 0, 7, 25, (int)date('Y') + 1);
        $timeToBirthday = $birthday - $now;
    }
    ...
    <p>До моего дня рождения: <?php echo "$days дней, $hours часов, $minutes минут, $seconds секунд"; ?></p>
