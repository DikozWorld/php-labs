...
<body>
	...
	*/
	...
	echo "<h2>Реализация с помощью switch:</h2>";
	...
	echo "<h2>Альтернативная реализация switch:</h2>";
	...
	switch ($day) {
		...
		case 4:
		case 5:
			echo "Это рабочий день (день $day)";
			break;
		case 6:
		case 7:
			echo "Это выходной день (день $day)";
			break;
		default:
			echo "Неизвестный день (день $day)";
	}
	?>
