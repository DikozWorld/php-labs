...
<body>
	...
	*/
	...
	echo "<hr><h3>Проверка условий:</h3>";
	echo "<ul>";
	echo "<li>Возраст от 18 до 59: " . (($age >= 18 && $age <= 59) ? "ДА" : "нет") . "</li>";
	echo "<li>Возраст больше 59: " . (($age > 59) ? "ДА" : "нет") . "</li>";
	echo "<li>Возраст от 1 до 17: " . (($age >= 1 && $age <= 17) ? "ДА" : "нет") . "</li>";
	echo "<li>Неизвестный возраст (все остальные случаи): " . 
		 (($age < 1 || ($age > 17 && $age < 18) || $age > 59) ? "ДА" : "нет") . "</li>";
	echo "</ul>";
	?>
